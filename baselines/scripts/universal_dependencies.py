...
_UD_DATASETS = {
    "sjo_xdt":{
        "test": "UD_Xibe-XDT/r2.11/sjo_xdt-ud-test.conllu",
    },
    "ro_art":{
        "test": "UD_Romanian-ArT/r2.11/ro_art-ud-test.conllu",
    },
    "quc_iu":{
        "test": "UD_Kiche-IU/r2.11/quc_iu-ud-test.conllu",
    },
    "is_modern":{
        "train": "UD_Icelandic-Modern/r2.11/is_modern-ud-train.conllu",
        "dev": "UD_Icelandic-Modern/r2.11/is_modern-ud-dev.conllu",
        "test": "UD_Icelandic-Modern/r2.11/is_modern-ud-test.conllu",
    },
    "hyw_armtdp":{
        "train": "UD_Western_Armenian-ArmTDP/r2.11/hyw_armtdp-ud-train.conllu",
        "dev": "UD_Western_Armenian-ArmTDP/r2.11/hyw_armtdp-ud-dev.conllu",
        "test": "UD_Western_Armenian-ArmTDP/r2.11/hyw_armtdp-ud-test.conllu",
    },
    "tr_kenet":{
        "train": "UD_Turkish-Kenet/r2.11/tr_kenet-ud-train.conllu",
        "dev": "UD_Turkish-Kenet/r2.11/tr_kenet-ud-dev.conllu",
        "test": "UD_Turkish-Kenet/r2.11/tr_kenet-ud-test.conllu",
    },
    "hbo_ptnk":{
        "train": "UD_Ancient_Hebrew-PTNK/r2.11/hbo_ptnk-ud-train.conllu",
        "dev": "UD_Ancient_Hebrew-PTNK/r2.11/hbo_ptnk-ud-dev.conllu",
        "test": "UD_Ancient_Hebrew-PTNK/r2.11/hbo_ptnk-ud-test.conllu",
    },
    "qpm_philotis":{
        "train":"UD_Pomak-Philotis/r2.11/qpm_philotis-ud-train.conllu",
        "dev":"UD_Pomak-Philotis/r2.11/qpm_philotis-ud-dev.conllu",
        "test":"UD_Pomak-Philotis/r2.11/qpm_philotis-ud-test.conllu",
    },
    "nap_rb":{
